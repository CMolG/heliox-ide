...
- **Task 16 Step 4 (e2e diferencial):** ver «Entorno e2e» abajo — es el ÚNICO gate de F3 que puede quedar pendiente.
...
4. **Gate e2e = DIFERENCIAL** contra baseline ~62 (pre-#5 `4861434d`): cero fallos NUEVOS no-backlog. NO intentar "suite completa verde" hasta que #4 cierre.
