 ...
 * available from the underlying {@link io.heliox.sdk.provider.LlmProvider}.
 */
public class DagTelemetry {
     ...
     *
     * <ul>
     *   <li>{@code stepId}            – unique node identifier from {@link io.heliox.sdk.flow.StepConfig#id()}</li>
     *   <li>{@code inferenceMs}       – total wall-clock milliseconds spent inside
     *                                   {@link io.heliox.sdk.provider.LlmProvider#complete}, summed
     ...
     *                                   {@link io.heliox.sdk.validation.SchemaValidator#validate},
