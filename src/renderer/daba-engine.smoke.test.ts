// Smoke test for the @cmolg/daba-engine dependency (Task 9, plan
...
// `@cmolg/daba-engine` package coordinate declared in package.json — today via
...
import { screenToWorld, worldToScreen } from '@cmolg/daba-engine';

describe('@cmolg/daba-engine dependency resolution', () => {
