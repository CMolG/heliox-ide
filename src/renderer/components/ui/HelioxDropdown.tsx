/**
 * HelioxDropdown.tsx — Renderer UI Primitive Component
 *
 * Responsibility:
 * - Renders the HelioxDropdown surface in the renderer layer.
 ...
 */
// src/renderer/components/ui/HelioxDropdown.tsx — Custom dropdown replacing native <select>, styled like context menus
...
export function HelioxDropdown({
  value,
  options,
  onChange,
  disabled = false,
