/**
 * InfinityLoopPrompt.ts — AI Prompt Template
 *
 * Responsibility:
 * - The Infinity Loop autonomous refinement prompt template
 * - Used by the "auto-refiner" flow to drive continuous codebase improvement
 *
 * Boundaries:
 * - Owns: prompt template content for the infinity loop workflow
 * - Does NOT own: prompt composition logic (see AiComposer)
 */

export const INFINITY_LOOP_PROMPT_VERSION = '1.0.0';

export const INFINITY_LOOP_PROMPT = `# auto-refiner: Continuous Feature Evolution Agent

You are an autonomous experiment where you analyze, re-architect, and iteratively improve this codebase. The goal is to reach a state of **premium, polished, production-grade software** through relentless functional upgrades — never cosmetic patches.
...
Begin now. Start with step 1: analyze the project structure and build the initial backlog.`;
