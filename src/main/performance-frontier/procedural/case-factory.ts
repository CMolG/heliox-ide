...
function makeFromScratchSteps(): Record<string, AgenticStep> {
  ...
  const review: AgenticStep = {
    ...
    prompt: [
      ...
      'read_file a handful of key files (Landing, a Seo/Head component, auth-schema, ProtectedRoute, App.tsx, one auth page, one test), then immediately write REVIEW.md with this structure:',
